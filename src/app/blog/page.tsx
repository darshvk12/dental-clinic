...
export const metadata: Metadata = {
  ...
  description:
    "Expert dental health articles by Dr. Pooja Bala. Covering oral hygiene, cosmetic dentistry, implants, kids dental health, and more. Updated monthly.",
                ...
                <article key={post.id} className="bg-white rounded-2xl overflow-hidden border border-dental-slate-100 shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all duration-300">
                  ...
                  <div className="p-5">
                    <span className="inline-flex items-center gap-2 text-[0.65rem] font-semibold uppercase tracking-[0.18em] text-dental-mint mb-3">
                      <span className="w-2 h-2 rounded-full bg-dental-mint" />
                      {post.category}
                    </span>
        ...
        <section className="py-16 bg-dental-navy-50 border-t border-dental-navy-100">
          <div className="container-dental text-center">
            ...
            <p className="text-dental-slate-500 text-sm mb-6 max-w-md mx-auto">
              Monthly insights from Dr. Pooja Bala — no spam, just genuinely useful dental health advice.
            </p>
            <NewsletterForm />
